...
async function fetchSensorData(source, apiKey) {
    // https://airkaz.org/api/v0.1/?type=IQair&token=oBZAolofFdvhgjbduFaY
    const url = new URL('/api/v0.1/', source.meta.url);
    url.searchParams.append('type', 'IQair');
    url.searchParams.append('token', 'oBZAolofFdvhgjbduFaY');
