...
async function processor(source_name, source) {
    ...
    try {
        ...
        for (const loc of locs) {
            ...
            for (const cnt of ['pm1.0', 'pm2.5', 'pm10.0', '0.3_um_count', '0.5_um_count', '1.0_um_count', '2.5_um_count', '5.0_um_count', '10.0_um_count', 'humidity', 'temperature', 'pressure', 'voc', 'ozone1']) {
                if (loc[cnt] === null) continue;

                const system = new SensorSystem({
                    sensor_system_id: `${loc.sensor_index}-${cnt}`
                });
                ...
                sta.sensor_systems.push(system);
            }
