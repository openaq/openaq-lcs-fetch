...
class SensorSystem {
    ...
    json() {
        return {
            ...
            sensors: self.sensors.map(s => s.json)
        }
    }
}
...
class Sensor {
    ...
    json() {
        return {
            ...
            sensor_system_id: self.sensor_system_id,
            sensor_data_averaging_period: self.sensor_data_averaging_period,
            sensor_data_averaging_period_unit: self.sensor_data_averaging_period_unit,
            sensor_data_logging_interval_second: self.sensor_data_logging_interval_second,
            sensor_lifecycle_stage: self.sensor_lifecycle_stage,
            sensor_description: self.sensor_description,
            sensor_deployed_by: self.sensor_deployed_by,
            sensor_deployment_date: self.sensor_deployment_date,
            sensor_deactivation_date: self.sensor_deactivation_date,
            sensor_deployment_notes: self.sensor_deployment_notes,
            sensor_firmware_version: self.sensor_firmware_version,
            sensor_flow_rate_unit: self.sensor_flow_rate_unit,
            sensor_flow_rate: self.sensor_flow_rate,
            sensor_calibration_procedure: self.sensor_calibration_procedure,
            sensor_last_calibration_timestamp: self.sensor_last_calibration_timestamp,
            sensor_last_service_timestamp: self.sensor_last_service_timestamp,
            sensor_manufacturer_batch_number: self.sensor_manufacturer_batch_number,
            sensor_manufacturer_name: self.sensor_manufacturer_name,
            sensor_model_name: self.sensor_model_name,
            sensor_model_version_name: self.sensor_model_version_name,
            sensor_origin_date: self.sensor_origin_date,
            sensor_purchase_date: self.sensor_purchase_date,
            sensor_sampling_duration: self.sensor_sampling_duration,
            sensor_serial_number: self.sensor_serial_number,
            sensor_measurand_id: self.sensor_measurand_id,
